/*
 *  @(#)AbstractSuspendedPowerState.java
 *
 *  Created:	Oct 2, 2006
...
/**
 * An abstract implementation of an SUSPENDED PowerState. Implements methods
 * which would be constant across all power states which are SUSPENDED.
 * 
 ...
 * 
 */
public abstract class AbstractSuspendedPowerState implements PowerState {
