...
/**
 * Handler for switching the 3d view into edit mode.
 * 
 * @author Jochen Mader - jochen@pramari.com - Feb 17, 2008
 * 
 */
public class EditModeHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		((View3D) PlatformUI.getWorkbench().getActiveWorkbenchWindow()
				.getActivePage().findView(View3D.ID)).switchMode(Mode.PickMode);
		return null;
	}
