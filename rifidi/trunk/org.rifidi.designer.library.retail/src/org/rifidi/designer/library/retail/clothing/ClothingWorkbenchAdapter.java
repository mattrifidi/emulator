 ...
 *
 */
public class ClothingWorkbenchAdapter implements IWorkbenchAdapter{
	...
	public ImageDescriptor getImageDescriptor(Object object) {
		return Activator.getDefault().getImageRegistry().getDescriptor(Clothing.class.getName());
	}
