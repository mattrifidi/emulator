package org.rifidi.prototyper.map;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.rifidi.prototyper.map";
	...
	protected void initializeImageRegistry(ImageRegistry reg) {
		...
		reg.put(IMG_ANT_ON, getImageDescriptor("IMG/antenna-on.png"));
		reg.put(IMG_ANT_OFF, getImageDescriptor("IMG/antenna-off.png"));
