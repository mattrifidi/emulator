...
public class IpAddressValidator implements ICellEditorValidator {
	private static Pattern ipaddress = Pattern
	...
	public String isValid(Object value) {
		...
		if (value.getClass().equals(String.class)) {
			...
			// TODO keep track of used IPAddresses
			// if (!ReaderRegistry.getInstance().inetSocketAddressAvailable(new
	...
	public String isValidIP(Object value)
	{
		if (!ipaddress.matcher((String)value).matches())
			return ("Invalid IP Address");
		else
			return null;
	}
