...
/**
 * 
 * Handler for enabling/disabling physics debugging.
 * 
 * @author Jochen Mader - jochen@pramari.com - Feb 17, 2008
 * 
 */
public class PhysicsDebuggingHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		if (GlobalProperties.physicsDebugging) {
			GlobalProperties.physicsDebugging = false;
			return null;
		}
		GlobalProperties.physicsDebugging = true;
		return null;
	}
