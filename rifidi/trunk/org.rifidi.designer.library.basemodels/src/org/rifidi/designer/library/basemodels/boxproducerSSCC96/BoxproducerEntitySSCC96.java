...
public class BoxproducerEntitySSCC96 extends VisualEntity implements SceneControl,
		Switch {
	/**
	 * Logger for this class.
	 */
	private static Log logger = LogFactory.getLog(BoxproducerEntitySSCC96.class);
	/**
	 * Seconds per box.
	 */
	private float speed;
