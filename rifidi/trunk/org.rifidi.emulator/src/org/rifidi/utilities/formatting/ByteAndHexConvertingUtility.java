...
public class ByteAndHexConvertingUtility {
	...
	private static Log logger = LogFactory.getLog(ByteAndHexConvertingUtility.class);
	...
	public static int unsignedByteToInt(byte b1, byte b2, byte b3, byte b4) {
		int i = (unsignedByteToInt(b1) << 24) + (unsignedByteToInt(b2) << 16) + (unsignedByteToInt(b3) << 8) + unsignedByteToInt(b4);
		return i;
	}
