 ...
 * 
 */
public class GPIOEditPart extends AbstractGraphicalEditPart implements
	 ...
	 * 
	 * @param gpio
	 *            an entity implementing both gpi and gpo.
	 * @param count
	 * @param cablingService
	 */
	public GPIOEditPart(Entity gpio, int count) {
		super();
		this.count = count;
		setModel(gpio);
	...
	protected IFigure createFigure() {
		...
		label = new Label();
		label.setText("gpio: " + ((Entity) getModel()).getName());
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new GraphicalNodeEditPolicy() {
					...
					protected Command getConnectionCompleteCommand(
						...
						CableCreateCommand cmd = (CableCreateCommand) request
								.getStartCommand();
						cmd.setTarget((GPI) getHost().getModel());
						return cmd;
					}
					...
					protected Command getConnectionCreateCommand(
						...
						CableCreateCommand cmd = new CableCreateCommand(source, cablingService);
