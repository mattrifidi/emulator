 ...
 *
 */
public class RetailBoxWorkbenchAdapter implements IWorkbenchAdapter{
	...
	public ImageDescriptor getImageDescriptor(Object object) {
		return Activator.getDefault().getImageRegistry().getDescriptor(RetailBox.class.getName());
	}
