...
public class GID96 {
	...
	public static final String tagFormat = "GID-96";

	public static final String header = "35";

	private static SecureRandom secureRandom = new SecureRandom();
	
	public static String getRandomTagData() {
	...
	protected BigInteger parseEncoding(String encoding) throws NumberFormatException {
