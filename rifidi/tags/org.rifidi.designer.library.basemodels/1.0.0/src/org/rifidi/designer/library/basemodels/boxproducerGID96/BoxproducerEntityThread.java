...
public class BoxproducerEntityThread extends Thread {
	 ...
	 */
	private BoxproducerEntityGID96 entity;
	/**
	 ...
	 *            reference to the product service
	 */
	public BoxproducerEntityThread(BoxproducerEntityGID96 entity,
	...
	public void run() {
		...
		while (keepRunning) {
			if(!paused){
				RifidiTag name = entity.getTagService().getRifidiTag("GID96");
				if (name != null) {
