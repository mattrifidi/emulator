 ...
 * 
 */
public class GPIEditPart extends AbstractGraphicalEditPart implements
	 ...
	 * @param count
	 */
	public GPIEditPart(GPI gpi, int count) {
		super();
		this.count = count;
		setModel(gpi);
	...
	protected IFigure createFigure() {
		...
		label = new Label();
		label.setText("gpi: " + ((Entity) getModel()).getName());
	...
	protected void refreshVisuals() {
		...
		((GraphicalEditPart) getParent()).setLayoutConstraint(this, rectangle,
				new Rectangle(150 * count + 30, 300, -1, -1));
	}
